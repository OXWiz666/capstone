...
const Header = ({ auth }: { auth: { user?: { firstname: string, lastname: string } } }) => {
            ...
            <div className="container mx-auto h-full flex items-center justify-between px-4">
                                ...
                                >
                                    <div className="flex items-center">
                                        <svg className="w-5 h-5 mr-2 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2m14 0V5a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                                        </svg>
                                        Services
                                    </div>
                                    <svg
                                    ...
                                    <div className="pl-10 pr-3 py-1 space-y-1">
                                        ...
                                        >
                                            <svg className="w-4 h-4 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.707 9.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-7-7A.997.997 0 012 10V5a3 3 0 013-3h5c.256 0 .512.098.707.293l7 7zM5 6a1 1 0 100-2 1 1 0 000 2z"></path>
                                            </svg>
                                            Vaccinations
                                        </Link>
                                    </div>
                    ...
                    <ul className="flex space-x-6">
                        ...
                        <li className="relative">
                            <button
                                ...
                                className={`nav-link group inline-flex h-8 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-all duration-300 hover:bg-gray-100 hover:text-gray-900 relative ${
                                    servicesDropdownOpen ? 'bg-gray-100 text-gray-900' : ''
                                }`}
                            >
                                <span>Services</span>
                                <svg
                            ...
                            {servicesDropdownOpen && (
                                ...
                                >
                                    <div className="space-y-2">
                                        ...
                                        >
                                            <svg className="mr-3 h-5 w-5 text-gray-400 group-hover:text-black transition-colors duration-300" viewBox="0 0 20 20" fill="currentColor">
                                                <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                                            </svg>
                                            <div>
                                                <p className="text-sm font-medium text-gray-900 group-hover:text-black transition-colors duration-300">Appointments</p>
                                                <p className="text-xs text-gray-500 group-hover:text-gray-600 transition-colors duration-300">Schedule your visit to the health center</p>
                                            </div>
                                        </Link>
                                        <Link
                                            href="#"
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-gray-900 group-hover:text-black transition-colors duration-300">Medical Records</p>
                                                <p className="text-xs text-gray-500 group-hover:text-gray-600 transition-colors duration-300">Access your health records securely</p>
                                            </div>
                                        </Link>
                                        <Link
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-gray-900 group-hover:text-black transition-colors duration-300">Vaccinations</p>
                                                <p className="text-xs text-gray-500 group-hover:text-gray-600 transition-colors duration-300">View vaccination schedules and availability</p>
                                            </div>
                                        </Link>
                                    </div>
                                </div>
                ...
                <div className="flex items-center">
                    {!auth?.user ? (
                        ...
                        >
                            <svg className="h-4 w-4 text-gray-600 group-hover:text-black transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`group inline-flex h-8 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-all duration-300 hover:bg-gray-100 hover:text-gray-900 relative ${
                                    userMenuOpen ? 'bg-gray-100 text-gray-900' : ''
                                }`}
                            >
