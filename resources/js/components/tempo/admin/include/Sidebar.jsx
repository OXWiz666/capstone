        ...
        <div className="flex items-center">
          {!collapsed && (
            <div className="flex flex-col">
              <h1 className="font-bold text-lg text-primary">RHU Calumpang</h1>
              <p className="text-xs text-muted-foreground">Management System</p>
            </div>
          )}
          {collapsed && (
            <div className="mx-auto">
              <span className="font-bold text-xl text-primary">RHU</span>
            </div>
          )}
        </div>
        <Button
        ...
        <div className={cn("flex items-center", collapsed && "justify-center")}>
          ...
          {!collapsed && (
            <div className="ml-3">
              ...
              <p className="text-xs text-muted-foreground">{role.roletype}</p>
            </div>
          )}
        </div>
