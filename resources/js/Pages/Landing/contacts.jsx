...
const ContactSection = () => {
  ...
  return (
    <LandingLayout>
        <section className="w-full py-16 px-4 mt-6 md:px-8 bg-white" id="contact">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg h-64 md:h-[400px] border border-gray-100 transition-all duration-300 hover:shadow-xl relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-gray-900/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 pointer-events-none" />
              <iframe
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="relative group">
                  ...
                  <div className="relative">
                    ...
                    />
                    <div
                      className="absolute inset-0 rounded-lg bg-gradient-to-r from-gray-900 to-gray-800 opacity-0 group-hover:opacity-[0.02] transition-opacity pointer-events-none">
                    </div>
                  </div>
                </div>
