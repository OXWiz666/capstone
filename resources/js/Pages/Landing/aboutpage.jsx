...
<LandingLayout className="pt-20">
    ...
    <main className="">
        ...
        <div className="relative bg-gray-900 text-white py-20 overflow-hidden">
            <div
                className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1200&q=80')] bg-cover bg-center animate-pulse" />
        ...
        <div className="container mx-auto px-4 py-16">
            {/* Mission Section */}
            <div
                className="max-w-4xl mx-auto bg-gray-700 rounded-xl shadow-lg overflow-hidden mb-16 transform transition-all hover:scale-[1.01] duration-300 animate-fade-in">
                <div className="md:flex items-stretch">
                    ...
                    <div className="p-8 md:w-3/5 flex flex-col justify-center">
                        <div
                            className="inline-block px-3 py-1 rounded-full bg-gray-600 text-gray-200 font-semibold text-sm mb-4 animate-bounce">
                            Our Mission
                        </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 mb-16">
                <div
                    className="max-w-4xl mx-auto bg-gray-700 rounded-xl shadow-lg overflow-hidden mb-8 transform transition-all hover:scale-[1.01] duration-300 animate-fade-in">
            ...
            <div className="mb-16 animate-fade-in">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div
                        className="bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:bg-gray-700 transform hover:scale-105 animate-fade-in-up delay-200">
                        <div className="h-48 overflow-hidden">
                            <img src="https://i.ibb.co/JWRKq5Qg/empty-doctors-workplace-room-with-desk-technology.jpg"
                                alt="Consultation Room" className="w-full h-full object-cover object-center" />
                        </div>
                        <div className="p-6">
                    ...
                    <div
                        className="bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:bg-gray-700 transform hover:scale-105 animate-fade-in-up delay-300">
                        <div className="h-48 overflow-hidden">
                            <img src="https://i.ibb.co/Xxdt0W4v/selective-focus-medical-bed-empty-hospital-office-with-nobody-it.jpg"
                                alt="Treatment Area" className="w-full h-full object-cover object-center" />
                        </div>
                        <div className="p-6">
                            <h3 className="font-bold text-xl mb-3 text-gray-100">
                                Treatment Area
                    ...
                    <div
                        className="bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:bg-gray-700 transform hover:scale-105 animate-fade-in-up delay-400">
                        <div className="h-48 overflow-hidden">
                            <img src="https://i.ibb.co/1GGW8fVx/programmer-night.jpg" alt="Digital Access Point"
            ...
            <div
                ...
                <div className="md:flex items-stretch">
                    <div className="md:w-2/5 relative">
                        ...
                        <img src="https://i.ibb.co/hF4BgykD/wallpaperflare-com-wallpaper.jpg" alt="Vision"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                <div
                    className="rounded-xl overflow-hidden h-48 md:h-64 transform hover:scale-105 transition-all duration-300 animate-fade-in">
                    <img src="https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=600&q=80"
                        alt="Health center"
                        className="w-full h-full object-cover transition-all duration-300 hover:scale-110" />
                </div>
                <div
                    className="rounded-xl overflow-hidden h-48 md:h-64 transform hover:scale-105 transition-all duration-300 animate-fade-in animation-delay-200">
                    <img src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=600&q=80"
                        alt="Medical consultation"
                        className="w-full h-full object-cover transition-all duration-300 hover:scale-110" />
                </div>
                <div
                    className="rounded-xl overflow-hidden h-48 md:h-64 transform hover:scale-105 transition-all duration-300 animate-fade-in animation-delay-400">
                    <img src="https://images.unsplash.com/photo-1584982751601-97dcc096659c?w=600&q=80"
                        alt="Healthcare worker"
                        className="w-full h-full object-cover transition-all duration-300 hover:scale-110" />
                </div>
                <div
                    className="rounded-xl overflow-hidden h-48 md:h-64 transform hover:scale-105 transition-all duration-300 animate-fade-in animation-delay-600">
