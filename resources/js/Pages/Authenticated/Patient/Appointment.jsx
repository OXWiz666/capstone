            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="w-full md:w-1/4">
                    <Card className="bg-white sticky top-4">
                        ...
                        <CardContent>
                            <div className="">
                                <Button variant={activeTab === "records" ? "secondary" : "ghost" }
                                    className="w-full justify-start" size="lg" onClick={()=>
                                    setActiveTab("records")}
                                    >
                                    <FileText className="mr-2 h-5 w-5" />
                                    Schedule Appointment
                                </Button>
                                <Button variant={ activeTab === "prescriptions" ? "secondary" : "ghost" }
                                    className="w-full justify-start" size="lg" onClick={()=>
                ...
                <div className="w-full md:w-3/4">
                    ...
                    <AppointmentForm services={services} formData={data} setFormData={setData}       errors={errors} processing={processing}  onSubmit={handleSubmit} />
                </div>
            </div>
        </div>
        )}
