                                ...
                                {appointments.data.map((a,i) => (
                                    <div key={i} className="p-4 hover:bg-muted/20 transition-colors">
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-2">
                                            {a.status == 1 ? (
                                                <div
                                                    className="text-xs bg-blue-500 text-white px-2 py-1 rounded-full flex items-center">
                                                    <Clock9 className="h-3 w-3 mr-1" />
                                                    Scheduled
                                                </div>
                                            ) : a.status == 2 ? (
                                                <div
                                                        className="text-xs bg-green-500 text-white px-2 py-1 rounded-full flex items-center">
