                                ...
                                <div className="mt-1 relative">
                                    <button
                                        ...
                                        className={`relative w-full bg-gray-50 pl-10 pr-10 py-3 text-left cursor-pointer rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200 ease-in-out hover:bg-gray-100 ${
                                            showSecurityDropdown ? 'ring-2 ring-black' : ''
                                        }`}
                                    >
                                        ...
                                        <span className="absolute inset-y-0 right-0 flex items-center pr-3">
                                            <svg
                                                className={`h-5 w-5 text-gray-400 transform transition-transform duration-200 ${
                                                    showSecurityDropdown ? 'rotate-180' : ''
                                                }`}
                                    ...
                                    {showSecurityDropdown && (
                                        ...
                                        >
                                            <select
                                                ...
                                                onChange={(e) => setData('securityQuestion', e.target.value)}
                                            >
                                            ...
                                            {questions.map((question) => (
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        setData('securityQuestion', question.id);
                                                    ...
                                                    className={`w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-black transition-colors cursor-pointer flex items-center space-x-2 ${
                                                        selectedQuestion === question.question ? 'bg-gray-50' : ''
                                                    }`}
                                                >
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setData('securityAnswer', e.target.value)}
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8">
                            ...
                            >
                                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <svg className="h-5 w-5 text-gray-400 group-hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                                    </svg>
                                </span>
