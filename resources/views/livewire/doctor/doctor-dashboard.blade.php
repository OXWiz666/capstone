                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">Patient Statistics</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Over 500 patients</span>
                            </h3>
            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">Appointment</span>
                            <span class="text-muted mt-1 fw-bold fs-7">Preview monthly appointments</span>
                        </h3>
                        <div class="card-toolbar">
