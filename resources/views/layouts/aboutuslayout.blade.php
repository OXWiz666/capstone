...
<body class="bg-gradient-to-b from-slate-50 to-white">
    ...
    <main class="flex-grow">
        ...
        <div class="container mx-auto px-4 py-16">
            <!-- Mission Section -->
            <div class="max-w-4xl mx-auto bg-gray-700 rounded-xl shadow-lg overflow-hidden mb-16 transform transition-all hover:scale-[1.01] duration-300 animate-fade-in">
            ...
            <div class="mb-16 animate-fade-in">
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-center mb-8 text-gray-800 animate-slide-up">
                        Our Facilities
                    </h2>
                    <p class="text-gray-800 max-w-2xl mx-auto animate-slide-up delay-100">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:bg-gray-700 transform hover:scale-105 animate-fade-in-up delay-200">
                        <div class="h-48 overflow-hidden">
                            <img src="https://i.ibb.co/JWRKq5Qg/empty-doctors-workplace-room-with-desk-technology.jpg" alt="Consultation Room" class="w-full h-full object-cover object-center">
                        </div>
                        <div class="p-6">
                            <h3 class="font-bold text-xl mb-3 text-gray-100">
                                Consultation Rooms
                            </h3>
                    ...
                    <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:bg-gray-700 transform hover:scale-105 animate-fade-in-up delay-300">
                        <div class="h-48 overflow-hidden">
                            <img src="https://i.ibb.co/Xxdt0W4v/selective-focus-medical-bed-empty-hospital-office-with-nobody-it.jpg" alt="Treatment Area" class="w-full h-full object-cover object-center">
                        </div>
                        <div class="p-6">
                            <h3 class="font-bold text-xl mb-3 text-gray-100">
                                Treatment Area
                    ...
                    <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:bg-gray-700 transform hover:scale-105 animate-fade-in-up delay-400">
                        <div class="h-48 overflow-hidden">
                            <img src="https://i.ibb.co/1GGW8fVx/programmer-night.jpg" alt="Digital Access Point" class="w-full h-full object-cover object-center transition-transform duration-300 hover:scale-110">
                        </div>
                        <div class="p-6">
                            <h3 class="font-bold text-xl mb-3 text-gray-100">
            ...
            <div class="max-w-4xl mx-auto bg-gray-700 rounded-xl shadow-lg overflow-hidden mb-16 transform transition-all hover:scale-[1.01] duration-300 animate-fade-in">
                <div class="md:flex items-stretch">
                    <div class="md:w-2/5 relative">
                        ...
                        <img src="https://i.ibb.co/hF4BgykD/wallpaperflare-com-wallpaper.jpg" alt="Vision" class="w-full h-full object-cover object-center mix-blend-overlay">
                    </div>
                    <div class="p-8 md:w-3/5 flex flex-col justify-center bg-gray-800">
                        <span class="inline-block px-3 py-1 rounded-full bg-gray-600 text-gray-200 font-semibold text-sm mb-4 animate-bounce">
                            Our Vision
                        </span>
                        <h2 class="text-2xl font-bold text-gray-200 mb-4 animate-fade-in-right">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                <div class="rounded-xl overflow-hidden h-48 md:h-64 transform hover:scale-105 transition-all duration-300 animate-fade-in">
                    <img
                ...
                <div class="rounded-xl overflow-hidden h-48 md:h-64 transform hover:scale-105 transition-all duration-300 animate-fade-in animation-delay-200">
                    <img
                ...
                <div class="rounded-xl overflow-hidden h-48 md:h-64 transform hover:scale-105 transition-all duration-300 animate-fade-in animation-delay-400">
                    <img
                ...
                <div class="rounded-xl overflow-hidden h-48 md:h-64 transform hover:scale-105 transition-all duration-300 animate-fade-in animation-delay-600">
                    <img
            ...
            <!-- Call to Action -->
            <div class="bg-white rounded-xl shadow-lg p-8 text-center max-w-3xl mx-auto">
                ...
                <a
                    href="/contact"
                    class="inline-block bg-gray-800 hover:bg-gray-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                >
                    Contact Us
                </a>
            </div>
