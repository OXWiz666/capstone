        ...
        @auth
            <li x-data="{ open: false }" class="relative list-none">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    class="absolute left-0 mt-2 w-48 origin-top-right rounded-xl bg-white p-2 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none"
                    style="display: none;">
                    <div class="space-y-2">
                        <a href="{{Route('logout')}}"
                            class="group flex items-center rounded-lg p-1 hover:bg-gray-50 transition-all duration-300">
                            <svg class="mr-1 h-3 w-3 text-gray-400 group-hover:text-black transition-colors duration-300"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z"
                                    clip-rule="evenodd" />
                            </svg>
                            <span class="text-xs font-medium text-gray-900 group-hover:text-black transition-colors duration-300">
                                Logout
                            </span>
                        </a>
                    </div>
