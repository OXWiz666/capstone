    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-xl font-bold text-white">Calumpang Rural Health Unit</h3>
                </div>
            ...
            <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start">
                        ...
                        <span class="text-gray-400">Calumpang, General Santos, Soccsksargen, Philippines</span>
                    </div>
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-400">(083) 554-0146</span>
                    </div>
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-gray-400 mr-3">
                        ...
                        <span class="text-gray-400">calumpangrhu@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm text-center md:text-left">
                © {{ date('Y') }} Barangay Calumpang Rural Health Unit. All rights reserved.
            </p>
            <a href="https://www.facebook.com/kyutiekev" target="_blank" class="text-blue-500 hover:underline mt-2 md:mt-0">
                Developed by Kevin Jumawak.
            </a>
